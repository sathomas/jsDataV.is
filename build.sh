...
cat src/text/ch8/*.md  | sed -e 's_NEXTFIGURENUMBER_\<span class="nextfigure"/\>_g' -e 's_LASTFIGURENUMBER_\<span class="lastfigure"/\>_g' | pandoc --smart -f markdown -t html5 -o build/chap08.kit
...
cat src/text/apnd/*.md | sed -e 's_NEXTFIGURENUMBER_\<span class="nextfigure"/\>_g' -e 's_LASTFIGURENUMBER_\<span class="lastfigure"/\>_g' | pandoc --smart -f markdown -t html5 -o build/apnd.kit
