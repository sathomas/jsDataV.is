...
You can even style the SVG elements using CSS. Here's how we could color the above image:
...
If you're curious, figure NEXTFIGURENUMBER shows how that SVG renders:
...
To summarize, here are the steps I normally take to create the SVG map.
...
<figcaption>CSS rules can set the styles for individual SVG elements within an SVG illustration.</figcaption>
</figure>
...
<figcaption>An HTML &lt;table&gt; can serve as a legend.</figcaption>
</figure>
...
<figcaption>Browsers (and a bit of code) can turn SVG illustrations into interactive visualizations.</figcaption>
</figure>
